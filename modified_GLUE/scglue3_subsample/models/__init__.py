...
def fit_SCGLUE(
    ...
    atac=adatas['atac']
    chrom,atac_seq = convert2sequence(atac[:,atac.var.query('highly_variable').index.to_numpy().tolist()])
    ...
    print('pretrain.fit---------------------')
    # pretrain = load_model("/home/ubuntu0/GLUE/glue/pretrain/pretrain.dill")
    ...
    if "directory" in finetune_fit_kws:
        finetune.save(os.path.join(finetune_fit_kws["directory"], "fine-tune20240111.dill"))
